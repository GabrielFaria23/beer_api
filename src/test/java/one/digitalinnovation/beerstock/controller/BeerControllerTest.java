...
import static one.digitalinnovation.beerstock.utils.JsonConvertionUtils.*;
...
public class BeerControllerTest {
    ...
    @Test
    void whenPATCHIsCalledToIncrementDiscountThenOkStatusIsReturned() throws Exception, BeerExcededException {
        //given
    ...
    @Test
    void wheenPATCHIsCalledToIncrementGreatherThanMaxThenBadRequestStatusIsReturnet() throws Exception, BeerExcededException {
        //given
        QuantityDTO quantityDTO = QuantityDTO.builder().quantity(10).build();
        ...
        //when
        when(beerService.increment(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerExcededException.class);
        ...
        @Test
    void whenPATCHIsCalledWithInvalidBeerIdToIncrementThenNotFoundStatusIsReturned() throws Exception, BeerExcededException {
    ...
    @Test
    void whenPATCHIsCalledToDecrementDiscountThenOKstatusIsReturned() throws Exception, BeerExcededException {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(5)
                .build();
    ...
    @Test
    void whenPATCHIsCalledToDEcrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception, BeerExcededException {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(60)
                .build();
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerExcededException.class);
    ...
    @Test
    void whenPATCHIsCalledWithInvalidBeerIdToDecrementThenNotFoundStatusIsReturned() throws Exception, BeerExcededException {
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(5)
                .build();
